(() => {
    ...
    function initSliders() {
        if (document.querySelector(".challenge-swiper")) new core(".challenge-swiper", {
            ...
            on: {
                init: function(swiper) {
                    ...
                    const allSlidesItems = document.querySelectorAll(".challenge-swiper-slide:not(.swiper-slide-duplicate)");
        ...
        if (document.querySelector(".courses-swiper")) new core(".courses-swiper", {
            modules: [ Navigation ],
            simulateTouch: true,
            touchRatio: 2,
            slidesPerView: 3,
        ...
        if (document.querySelector(".confidence-swiper")) new core(".confidence-swiper", {
            modules: [ Navigation ],
            slidesPerView: 4,
            spaceBetween: 26,
            slidesPerGroup: 1,
            ...
            loop: true,
            navigation: {
                prevEl: ".confidence-swiper-button-prev",
                nextEl: ".confidence-swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1
